...
Download EPL (English Premier League data) [here](https://github.com/Qprop/ExcelAdvNBO/tree/master/Exercise/Data/English Premier League_09_19) and [original sources](https://datahub.io/sports-data/english-premier-league#resource-english-premier-league_zip) **Requires Internet**

Or to downloand click on google drive link [here](https://drive.google.com/drive/folders/1IWUXH08OaDUqtGvd5v-GSw7lFgaeJglP?usp=sharing) this will send a request to access and once accepted you can access the data files here.
